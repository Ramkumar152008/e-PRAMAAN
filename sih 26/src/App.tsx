...
import { InvestigationAssistantModal } from './components/assistant/InvestigationAssistantModal';
...
const MainLayout: React.FC<MainLayoutProps> = ({ onLogout }) => {
  const { activeView, role, isAssistantOpen, closeAssistant, assistantInitialQuery } = useApp();
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col selection:bg-blue-100 selection:text-blue-900 font-sans antialiased">
      ...
      {/* Controlled Investigation Assistant Modal */}
      <InvestigationAssistantModal
