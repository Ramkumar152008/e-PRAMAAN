...
import { EvidenceConfidenceBreakdown } from '../shared/EvidenceConfidenceBreakdown';
        ...
        <div className="p-5 sm:p-6 space-y-5">
          ...
          {activeTab === 'COMPLIANCE' && (
            <div className="space-y-5">
              ...
              {/* Multi-Factor Forensic Evidence Confidence Breakdown */}
              <EvidenceConfidenceBreakdown
                overallConfidence={isReconciled ? 98.5 : 88.0}
                breakdown={{
                  ocrQuality: 98.2,
                  fieldExtraction: isReconciled ? 98.0 : 92.5,
                  referenceVerification: isReconciled ? 100.0 : 88.0,
                  entityResolution: 99.0,
                  temporalStatus: 'PASS',
              ...
              <div className="space-y-3">
                <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-200 pb-2.5">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      onClick={() => openAssistant("Explain all compliance requirements and discrepancies for this bidder")}
                      className="px-2.5 py-1 bg-blue-600 hover:bg-blue-500 text-white rounded-sm text-xs font-bold transition flex items-center gap-1.5 cursor-pointer shadow-2xs"
                    >
