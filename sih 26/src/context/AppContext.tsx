...
const CLAR_STORAGE_KEY = 'ebid_pramaan_clarifications';
...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const resetDemoData = () => {
    ...
    localStorage.removeItem('ebid_pramaan_audit_logs');
    localStorage.removeItem(CLAR_STORAGE_KEY);
    localStorage.removeItem('ebid_pramaan_system_notifications');
    localStorage.removeItem('ebid_pramaan_auth_session');
